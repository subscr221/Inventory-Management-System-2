...
const PERMANENT_ERROR_CODES = new Set([
  ...
  // Story 3.6: pick-task permanent business rejections
  'PICK_TASK_NOT_FOUND',
  'PICK_LINE_NOT_FOUND',
  ...
  // seams (FR-MO-13). The twin set in src/sync/upload.ts carries the identical block (the Story 4.3
  // rule); CENTRAL_ONLY_OPERATION, INSUFFICIENT_STOCK, LOT_REQUIRED, APPROVAL_REQUIRED and
  // INVALID_PAYLOAD are already present above.
  'ORDER_CLOSED',
