...
| Stable error codes | `CALIBRATION_LOCKOUT`, `INSUFFICIENT_STOCK`, `APPROVAL_REQUIRED`, `DUPLICATE_EVENT`, `STREAM_CONFLICT`, `UNTAGGED_TRANSACTION`, `GATE_PASS_REQUIRED`, `SOURCE_DOCUMENT_REQUIRED`, `CROSS_ISSUE_BLOCKED`, `CUSTODY_NOT_ZERO`, `LOT_EXPIRED`, `LOT_ON_HOLD`, `DUPLICATE_LOT`, `DUPLICATE_SERIAL`, `SERIAL_REQUIRED`, `SERIAL_NOT_ALLOWED`, `SERIAL_NOT_AVAILABLE`, `NO_AVAILABLE_LOT`, `LOT_NOT_FOUND`, `LOT_REQUIRED`, `SERIAL_NOT_FOUND`, `ITEM_NOT_FOUND`, `FUNCTION_ACCESS_DENIED`, `LOCATION_ACCESS_DENIED` |
